...
let UsersService = class UsersService {
    ...
    async createUser(createUserDto) {
        ...
        if (role === roles_enum_1.Role.SUPER_ADMIN) {
            ...
            if (existingSuperAdmin) {
                throw new common_1.ForbiddenException('Only one SUPER_ADMIN user can exist in the system');
            }
        }
    ...
    async deleteUser(userId, currentUserRole) {
        if (currentUserRole !== roles_enum_1.Role.SUPER_ADMIN) {
        ...
        if (user.role === roles_enum_1.Role.SUPER_ADMIN) {
            throw new common_1.BadRequestException('SUPER_ADMIN user cannot be deleted');
        }
